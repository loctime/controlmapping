...
import { checkCriticalFatigueAlert, formatFecha, generateCriticalAlertMessage } from "@/domains/vehiculo/criticalAlert"
...
export function CriticalSecurityDashboard({ 
  ...
  const criticalAlert = useMemo(() => checkCriticalFatigueAlert(eventos), [eventos])
                ...
                <div className="flex items-start justify-between gap-6 mb-3">
                  <div className="flex-1">
                    ...
                    <p className="text-base text-red-900 leading-relaxed">
                      {generateCriticalAlertMessage(criticalAlert)}
                    </p>
                  </div>
